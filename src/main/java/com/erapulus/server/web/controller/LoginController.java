...
public class LoginController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = OpenApiConstants.OK, content = @Content(schema = @Schema(implementation = LoginResponseDTO.class))),
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "201", description = OpenApiConstants.CREATED, content = @Content(schema = @Schema(implementation = LoginResponseDTO.class))),
                    @ApiResponse(responseCode = "400", description = OpenApiConstants.BAD_REQUEST),
                    @ApiResponse(responseCode = "500", description = OpenApiConstants.INTERNAL_SERVER_ERROR)
            }
    )
