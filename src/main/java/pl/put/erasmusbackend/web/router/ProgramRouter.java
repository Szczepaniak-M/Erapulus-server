...
import pl.put.erasmusbackend.web.controller.ProgramController;
...
import static pl.put.erasmusbackend.web.common.OpenApiConstants.PROGRAM_BASE_URL_OPENAPI;
import static pl.put.erasmusbackend.web.common.OpenApiConstants.PROGRAM_DETAILS_URL_OPENAPI;

@Configuration
public class ProgramRouter {
    public static final String PROGRAM_BASE_URL = format("/api/university/{%s}/faculty/{%s}/program", UNIVERSITY_PATH_PARAM, FACULTY_PATH_PARAM);
    public static final String PROGRAM_DETAILS_URL = format("/api/university/{%s}/faculty/{%s}/program/{%s}", UNIVERSITY_PATH_PARAM, FACULTY_PATH_PARAM, PROGRAM_PATH_PARAM);
